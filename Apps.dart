...
import 'package:my_project/CalculatorScreen.dart';
...
class Apps extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text("My Apps",style: TextStyle(fontWeight: FontWeight.bold,fontSize: 30,color: Colors.teal,fontFamily: 'Robotor'),),
        centerTitle: true,
        backgroundColor: Colors.black87, // Set the app bar color
      ),
      body: Container(
